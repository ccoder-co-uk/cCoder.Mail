...
public partial class MailServerEventServiceTests
{
    ...
    public async Task ShouldMapAndCallBrokerWhenRaiseMailServerUpdateEventAsync()
    {
        ...
        mailServerEventBrokerMock
            .Setup(expression: x => x.RaiseMailServerUpdateEventAsync(message: It.IsAny<EventMessage<cCoder.Data.Models.Mail.MailServer>>()))
...
expression: x => x.RaiseMailServerUpdateEventAsync(message: It.IsAny<EventMessage<cCoder.Data.Models.Mail.MailServer>>()),
times: Times.Once
        );
