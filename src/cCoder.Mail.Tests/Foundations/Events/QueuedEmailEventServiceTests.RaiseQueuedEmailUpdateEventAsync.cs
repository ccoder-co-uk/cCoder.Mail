...
public partial class QueuedEmailEventServiceTests
{
    ...
    public async Task ShouldMapAndCallBrokerWhenRaiseQueuedEmailUpdateEventAsync()
    {
        ...
        queuedEmailEventBrokerMock
            .Setup(expression: x => x.RaiseQueuedEmailUpdateEventAsync(message: It.IsAny<EventMessage<cCoder.Data.Models.Mail.QueuedEmail>>()))
...
expression: x => x.RaiseQueuedEmailUpdateEventAsync(message: It.IsAny<EventMessage<cCoder.Data.Models.Mail.QueuedEmail>>()),
times: Times.Once
        );
