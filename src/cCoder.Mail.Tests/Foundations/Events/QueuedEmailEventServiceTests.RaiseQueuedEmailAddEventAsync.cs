...
public partial class QueuedEmailEventServiceTests
{
    ...
    public async Task ShouldMapAndCallBrokerWhenRaiseQueuedEmailAddEventAsync()
    {
        ...
        queuedEmailEventBrokerMock
            .Setup(x => x.RaiseQueuedEmailAddEventAsync(It.IsAny<EventMessage<cCoder.Data.Models.Mail.QueuedEmail>>()))
        ...
        queuedEmailEventBrokerMock.Verify(
            x => x.RaiseQueuedEmailAddEventAsync(It.IsAny<EventMessage<cCoder.Data.Models.Mail.QueuedEmail>>()),
            Times.Once
        );
