...
{
    [Fact]
    public async Task ShouldMapAndCallBrokerWhenRaiseSentEmailUpdateEventAsync()
    {
        // Given
        ...
        sentEmailEventBrokerMock
            .Setup(expression: x => x.RaiseSentEmailUpdateEventAsync(message: It.IsAny<EventMessage<cCoder.Data.Models.Mail.SentEmail>>()))
...
expression: x => x.RaiseSentEmailUpdateEventAsync(message: It.IsAny<EventMessage<cCoder.Data.Models.Mail.SentEmail>>()),
times: Times.Once
        );
