...
public partial class SentEmailEventServiceTests
{
    ...
    public async Task ShouldMapAndCallBrokerWhenRaiseSentEmailUpdateEventAsync()
    {
        ...
        sentEmailEventBrokerMock
            .Setup(x => x.RaiseSentEmailUpdateEventAsync(It.IsAny<EventMessage<cCoder.Data.Models.Mail.SentEmail>>()))
        ...
        sentEmailEventBrokerMock.Verify(
            x => x.RaiseSentEmailUpdateEventAsync(It.IsAny<EventMessage<cCoder.Data.Models.Mail.SentEmail>>()),
            Times.Once
        );
