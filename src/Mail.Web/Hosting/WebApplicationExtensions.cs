...
namespace Mail.Web.Hosting;

internal static class WebApplicationExtensions
{
    internal static IServiceCollection AddMailWebApplication(
...
{
    ConnectionStrings =
                    new Dictionary<string, string>(dictionary: config.ConnectionStrings),

    Settings =
                    new Dictionary<string, string>(dictionary: config.Settings),

    Services =
                    new Dictionary<string, string>(dictionary: config.Services),
...
connectionString: coreConnection);
        ...
        services.AddMailWeb(newMailConfiguration: mailConfiguration =>
...
mailConfiguration: mailConfiguration));
    ...
    internal static WebApplication UseMailWebApplication(this WebApplication app)
    {
